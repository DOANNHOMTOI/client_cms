            ...
            <table class="table mb-0">
              ...
              <tbody>
                <tr v-for="(item, index) in list">
                  ...
                  <td>
                    <router-link v-if="getPermissionUser.includes('editVoucher')" :to="'/voucher/' + item.id"
                      class="btn btn-warning waves-effect waves-light">Sửa</router-link>
                    <button @click="deleteVoucher(item.id)" class="btn btn-danger waves-effect waves-light">Xoá</button>
                  </td>
                </tr>
              </tbody>
            </table>
