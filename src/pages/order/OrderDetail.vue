        ...
        <div class="card-box">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mt-3">
                ...
                <p v-if="order.voucher_id != null">Giảm trừ : <b> <span class="badge badge-danger">-{{ order.voucher_id.percent_value }} %</span></b></p>
              </div>
            ...
            <div class="col-md-4 offset-md-2">
              <div class="mt-3 float-right">
                ...
                <p class="m-b-10"><strong>Ngày tạo : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; {{ convertMoment(order.created_at) }}</span></p>
                <p class="m-b-10"><strong>Ngày cập nhật : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; {{ convertMoment(order.updated_at) }}</span></p>
              </div>
            </div><!-- end col -->
          </div>
          <!-- end row -->
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="float-right" style="display: flex;align-items: baseline">
               <span style="display: block;padding-right: 20px">Tổng :</span> <h3 style="color:black"> {{convertCurrency(order.total_price) }}</h3>
              </div>
          ...
          <div class="mt-4 mb-1">
            ...
            <div class="text-right d-print-none">
              ...
              <a v-if="order.status != 1" @click="changeSTT(1)" href="#" class="btn btn-primary waves-effect waves-light">NEW</a>
              <a v-if="order.status != 2" @click="changeSTT(2)" href="#" class="btn btn-info waves-effect waves-light">PROCESSING</a>
              <a v-if="order.status != 3" @click="changeSTT(3)" href="#" class="btn btn-success waves-effect waves-light">SUCCESS</a>
              <a v-if="order.status != 4" @click="changeSTT(4)" href="#" class="btn btn-danger waves-effect waves-light">CANCEL</a>
            </div>
          </div>
        </div> <!-- end card-box -->
      </div> <!-- end col -->
