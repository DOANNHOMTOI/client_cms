<template>
  <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="text-right">
                <h3 class="mt-1">
                  <span style="color: black" data-plugin="counterup">{{
                    total.orders
                  }}</span>
                </h3>
      ...
      <div class="col-md-6 col-xl-3">
        <div class="widget-rounded-circle card-box">
          <div class="row">
            <div class="col-6">
              <div
                class="avatar-lg rounded-circle bg-info border-info border shadow"
              >
                <i
                  class="fe-bar-chart-line- font-22 avatar-title text-white"
                ></i>
              </div>
            </div>
            <div class="col-6">
    ...
    <div
      v-if="orders != null"
      class="row mt-3"
      style=" padding: 20px 10px;border: 1px solid lightgray;background: powderblue;"
    >
      ...
      <div class="row">
        <form class="d-flex">
          ...
          <div class="form-group mb-3 mr-3">
            ...
            <button
              @click="search()"
              style="background-color: #4938d7;margin-top:7px"
              type="button"
              name="example-email"
          ...
          <div class="row">
            <div class="col-12">
              <div class="">
                <h3 class="mt-1">
                  <span style="color: black" data-plugin="counterup">{{
                    convertCurrency(orders.total_price)
                  }}</span>
                </h3>
    ...
    <div
      v-if="guest != null"
      class="row mt-3"
      style=" padding: 20px 10px;border: 1px solid lightgray;background: lightskyblue;"
    >
    ...
    <div v-if="recent != null" class="row">
      <div class="col-xl-6">
        <div class="card-box">
          <h4 style="color: black" class="header-title mb-3">
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <tbody>
                <tr v-for="(item, i) in recent.sp_ban_chay" :key="i">
                  <td>
        ...
        <div class="card-box">
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <tbody>
                <tr v-for="(item, i) in recent.don_gan_day" :key="i">
                  <td>
                    {{ item.sku }}
                  </td>
